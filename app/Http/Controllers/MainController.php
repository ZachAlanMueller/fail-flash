...
class MainController extends Controller
{
    ...
    public function displaySummoner($id){
        ...
        $lastGameFrames = DB::table('frames_participants')->join('summoner_games', 'summoner_games.participant_id', '=', 'frame_participants.participant_id')->where('summoner_games.game_id', $latestGameId)->where('frame_participants.game_id', $latestGameId)->orderBy('timestamp', 'asc')->orderBy('participant_id', 'asc')->get();

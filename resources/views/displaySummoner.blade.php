		...
		<div class="panel panel-primary">
            <div class="panel-heading">
                <div class="row">
					<div class="col-xs-6">
						<div class="row">
							<div class="col-xs-2" style="border-style: solid;border-width: 5px;border-color: red;">
								<img src="{{$summonerInfo->profile_img_link}}" class="img-circle" width="80px" height="80px">
							</div>
							<div class="col-xs-4" style="border-style: solid;border-width: 5px;border-color: red;">
								<div class="row">
